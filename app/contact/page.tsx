            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-6">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col items-start gap-4">
                        <Link href={'https://www.facebook.com/kiddeelab/'} className='text-3xl flex flex-row items-center gap-4'><FontAwesomeIcon icon={faSquareFacebook}/><span className='text-xl'>Facebook</span></Link>
                        <Link href={'https://www.instagram.com/kiddeelab'} className='text-3xl flex flex-row items-center gap-4'><FontAwesomeIcon icon={faSquareInstagram} /><span className='text-xl'>Instagram</span></Link>
                        <Link href={'https://page.line.me/kiddeelab'} className='text-[1.640625rem] flex flex-row items-center gap-4'><FontAwesomeIcon icon={faLine} /><span className='text-xl'>LINE</span></Link>
                        <Link href={'tel:0838871199'} className='text-[1.640625rem] flex flex-row items-center gap-4'><FontAwesomeIcon icon={faPhone} /><span className='text-xl'>0838871199</span></Link>
                    </div>
                </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 py-6">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-4 items-start">
                        <Link href={'https://www.facebook.com/KiddeeLab.Chaiyapruk'} className='text-3xl flex flex-row items-center gap-4'><FontAwesomeIcon icon={faSquareFacebook}/><span className='text-xl'> Facebook </span></Link>
                        <Link href={'https://line.me/R/ti/p/@373uxkbp'} className='text-[1.640625rem] flex flex-row items-center gap-4'><FontAwesomeIcon icon={faLine} /><span className='text-xl'>LINE</span></Link>
                        <Link href={'tel:0656954655'} className='text-[1.640625rem] flex flex-row items-center gap-4'><FontAwesomeIcon  icon={faPhone} /><span className='text-xl'>0656954655</span></Link>
                    </div>
                </div>
